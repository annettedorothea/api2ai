...
5. Open the demo folder as the workspace. In Cursor Settings → **Tools & MCP**, enable one server per demo (names in `.cursor/mcp.json`, e.g. `open-meteo`, `todo`, `bookings-oauth`).
