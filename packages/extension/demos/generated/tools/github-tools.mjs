...
export const inputZodByTool = {
    "getGitHubAuthenticatedUser": z.object({ "pathParams": z.record(z.string(), __core2aiPrimitiveUnion).describe("No path parameters.").optional(), "query": z.record(z.string(), __core2aiPrimitiveUnion).describe("Optional query overrides.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), __core2aiPrimitiveUnion).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "listGitHubUserRepos": z.object({ "pathParams": z.record(z.string(), __core2aiPrimitiveUnion).describe("No path parameters.").optional(), "query": z.object({ "type": z.union([z.literal("all"), z.literal("owner"), z.literal("member")]).describe("`all` (default), `owner` (repos owned by user), or `member` (repos user is member of but does not own).").optional(), "per_page": z.number().describe("Results per page (max 100).").optional(), "page": z.number().describe("Page number of results.").optional() }).strict().describe("Query parameters from OpenAPI.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), __core2aiPrimitiveUnion).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "getGitHubRepository": z.object({ "pathParams": z.object({ "owner": z.string(), "repo": z.string() }).strict().describe("Path parameters from OpenAPI."), "query": z.record(z.string(), __core2aiPrimitiveUnion).describe("Optional query overrides.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), __core2aiPrimitiveUnion).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper.")
};
