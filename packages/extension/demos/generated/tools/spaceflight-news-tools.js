...
export const inputZodByTool = {
    listSpaceflightArticles: z
        ...
        query: z
            ...
            news_site: z
                .string()
                .describe('Search for documents with a news_site__name present in a list of comma-separated values. Case insensitive.')
                .optional(),
            news_site_exclude: z
                .string()
                .describe('Search for documents with a news_site__name not present in a list of comma-separated values. Case insensitive.')
                .optional(),
            ...
            ordering: z
                ...
                .describe('Order the result on `published_at, -published_at, updated_at, -updated_at`.\n\n* `published_at` - Published at\n* `-published_at` - Published at (descending)\n* `updated_at` - Updated at\n* `-updated_at` - Updated at (descending)')
                .optional(),
            published_at_gt: z
                .string()
            ...
            summary_contains_one: z
                .string()
                .describe('Search for documents with a summary containing at least one keyword from comma-separated values.')
                .optional(),
            title_contains: z
                .string()
            ...
            title_contains_one: z
                .string()
                .describe('Search for documents with a title containing at least one keyword from comma-separated values.')
                .optional(),
            updated_at_gt: z
                .string()
