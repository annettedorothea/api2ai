...
export const inputZodByTool = {
    "listSpaceflightArticles": z.object({ "pathParams": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("No path parameters.").optional(), "query": z.object({ "event": z.array(z.number()).describe("Search for all documents related to a specific event using its Launch Library 2 ID.").optional(), "has_event": z.boolean().describe("Get all documents that have a related event.").optional(), "has_launch": z.boolean().describe("Get all documents that have a related launch.").optional(), "is_featured": z.boolean().describe("Get all documents that are featured.").optional(), "launch": z.array(z.string()).describe("Search for all documents related to a specific launch using its Launch Library 2 ID.").optional(), "limit": z.number().describe("Number of results to return per page.").optional(), "news_site": z.string().describe("Search for documents with a news_site__name present in a list of comma-separated values. Case insensitive.").optional(), "news_site_exclude": z.string().describe("Search for documents with a news_site__name not present in a list of comma-separated values. Case insensitive.").optional(), "offset": z.number().describe("The initial index from which to return the results.").optional(), "ordering": z.array(z.union([z.literal("-published_at"), z.literal("-updated_at"), z.literal("published_at"), z.literal("updated_at")])).describe("Order the result on `published_at, -published_at, updated_at, -updated_at`.\n\n* `published_at` - Published at\n* `-published_at` - Published at (descending)\n* `updated_at` - Updated at\n* `-updated_at` - Updated at (descending)").optional(), "published_at_gt": z.string().describe("Get all documents published after a given ISO8601 timestamp (excluded).").optional(), "published_at_gte": z.string().describe("Get all documents published after a given ISO8601 timestamp (included).").optional(), "published_at_lt": z.string().describe("Get all documents published before a given ISO8601 timestamp (excluded).").optional(), "published_at_lte": z.string().describe("Get all documents published before a given ISO8601 timestamp (included).").optional(), "search": z.string().describe("Search for documents with a specific phrase in the title or summary.").optional(), "summary_contains": z.string().describe("Search for all documents with a specific phrase in the summary.").optional(), "summary_contains_all": z.string().describe("Search for documents with a summary containing all keywords from comma-separated values.").optional(), "summary_contains_one": z.string().describe("Search for documents with a summary containing at least one keyword from comma-separated values.").optional(), "title_contains": z.string().describe("Search for all documents with a specific phrase in the title.").optional(), "title_contains_all": z.string().describe("Search for documents with a title containing all keywords from comma-separated values.").optional(), "title_contains_one": z.string().describe("Search for documents with a title containing at least one keyword from comma-separated values.").optional(), "updated_at_gt": z.string().describe("Get all documents updated after a given ISO8601 timestamp (excluded).").optional(), "updated_at_gte": z.string().describe("Get all documents updated after a given ISO8601 timestamp (included).").optional(), "updated_at_lt": z.string().describe("Get all documents updated before a given ISO8601 timestamp (excluded).").optional(), "updated_at_lte": z.string().describe("Get all documents updated before a given ISO8601 timestamp (included).").optional() }).strict().describe("Query parameters from OpenAPI.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "getSpaceflightArticleById": z.object({ "pathParams": z.object({ "id": z.number().describe("A unique integer value identifying this article.") }).strict().describe("Path parameters from OpenAPI."), "query": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Optional query overrides.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "listSpaceflightBlogs": z.object({ "pathParams": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("No path parameters.").optional(), "query": z.object({ "event": z.array(z.number()).describe("Search for all documents related to a specific event using its Launch Library 2 ID.").optional(), "has_event": z.boolean().describe("Get all documents that have a related event.").optional(), "has_launch": z.boolean().describe("Get all documents that have a related launch.").optional(), "is_featured": z.boolean().describe("Get all documents that are featured.").optional(), "launch": z.array(z.string()).describe("Search for all documents related to a specific launch using its Launch Library 2 ID.").optional(), "limit": z.number().describe("Number of results to return per page.").optional(), "news_site": z.string().describe("Search for documents with a news_site__name present in a list of comma-separated values. Case insensitive.").optional(), "news_site_exclude": z.string().describe("Search for documents with a news_site__name not present in a list of comma-separated values. Case insensitive.").optional(), "offset": z.number().describe("The initial index from which to return the results.").optional(), "ordering": z.array(z.union([z.literal("-published_at"), z.literal("-updated_at"), z.literal("published_at"), z.literal("updated_at")])).describe("Order the result on `published_at, -published_at, updated_at, -updated_at`.\n\n* `published_at` - Published at\n* `-published_at` - Published at (descending)\n* `updated_at` - Updated at\n* `-updated_at` - Updated at (descending)").optional(), "published_at_gt": z.string().describe("Get all documents published after a given ISO8601 timestamp (excluded).").optional(), "published_at_gte": z.string().describe("Get all documents published after a given ISO8601 timestamp (included).").optional(), "published_at_lt": z.string().describe("Get all documents published before a given ISO8601 timestamp (excluded).").optional(), "published_at_lte": z.string().describe("Get all documents published before a given ISO8601 timestamp (included).").optional(), "search": z.string().describe("Search for documents with a specific phrase in the title or summary.").optional(), "summary_contains": z.string().describe("Search for all documents with a specific phrase in the summary.").optional(), "summary_contains_all": z.string().describe("Search for documents with a summary containing all keywords from comma-separated values.").optional(), "summary_contains_one": z.string().describe("Search for documents with a summary containing at least one keyword from comma-separated values.").optional(), "title_contains": z.string().describe("Search for all documents with a specific phrase in the title.").optional(), "title_contains_all": z.string().describe("Search for documents with a title containing all keywords from comma-separated values.").optional(), "title_contains_one": z.string().describe("Search for documents with a title containing at least one keyword from comma-separated values.").optional(), "updated_at_gt": z.string().describe("Get all documents updated after a given ISO8601 timestamp (excluded).").optional(), "updated_at_gte": z.string().describe("Get all documents updated after a given ISO8601 timestamp (included).").optional(), "updated_at_lt": z.string().describe("Get all documents updated before a given ISO8601 timestamp (excluded).").optional(), "updated_at_lte": z.string().describe("Get all documents updated before a given ISO8601 timestamp (included).").optional() }).strict().describe("Query parameters from OpenAPI.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "getSpaceflightBlogById": z.object({ "pathParams": z.object({ "id": z.number().describe("A unique integer value identifying this blog.") }).strict().describe("Path parameters from OpenAPI."), "query": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Optional query overrides.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "listSpaceflightReports": z.object({ "pathParams": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("No path parameters.").optional(), "query": z.object({ "limit": z.number().describe("Number of results to return per page.").optional(), "news_site": z.string().describe("Search for documents with a news_site__name present in a list of comma-separated values. Case insensitive.").optional(), "news_site_exclude": z.string().describe("Search for documents with a news_site__name not present in a list of comma-separated values. Case insensitive.").optional(), "offset": z.number().describe("The initial index from which to return the results.").optional(), "ordering": z.array(z.union([z.literal("-published_at"), z.literal("-updated_at"), z.literal("published_at"), z.literal("updated_at")])).describe("Order the result on `published_at, -published_at, updated_at, -updated_at`.\n\n* `published_at` - Published at\n* `-published_at` - Published at (descending)\n* `updated_at` - Updated at\n* `-updated_at` - Updated at (descending)").optional(), "published_at_gt": z.string().describe("Get all documents published after a given ISO8601 timestamp (excluded).").optional(), "published_at_gte": z.string().describe("Get all documents published after a given ISO8601 timestamp (included).").optional(), "published_at_lt": z.string().describe("Get all documents published before a given ISO8601 timestamp (excluded).").optional(), "published_at_lte": z.string().describe("Get all documents published before a given ISO8601 timestamp (included).").optional(), "search": z.string().describe("Search for documents with a specific phrase in the title or summary.").optional(), "summary_contains": z.string().describe("Search for all documents with a specific phrase in the summary.").optional(), "summary_contains_all": z.string().describe("Search for documents with a summary containing all keywords from comma-separated values.").optional(), "summary_contains_one": z.string().describe("Search for documents with a summary containing at least one keyword from comma-separated values.").optional(), "title_contains": z.string().describe("Search for all documents with a specific phrase in the title.").optional(), "title_contains_all": z.string().describe("Search for documents with a title containing all keywords from comma-separated values.").optional(), "title_contains_one": z.string().describe("Search for documents with a title containing at least one keyword from comma-separated values.").optional(), "updated_at_gt": z.string().describe("Get all documents updated after a given ISO8601 timestamp (excluded).").optional(), "updated_at_gte": z.string().describe("Get all documents updated after a given ISO8601 timestamp (included).").optional(), "updated_at_lt": z.string().describe("Get all documents updated before a given ISO8601 timestamp (excluded).").optional(), "updated_at_lte": z.string().describe("Get all documents updated before a given ISO8601 timestamp (included).").optional() }).strict().describe("Query parameters from OpenAPI.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "getSpaceflightReportById": z.object({ "pathParams": z.object({ "id": z.number().describe("A unique integer value identifying this report.") }).strict().describe("Path parameters from OpenAPI."), "query": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Optional query overrides.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper."),
    "getSpaceflightInfo": z.object({ "pathParams": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("No path parameters.").optional(), "query": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Optional query overrides.").optional(), "headers": z.record(z.string(), z.string()).describe("Optional extra headers.").optional(), "body": z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])).describe("Request body JSON if applicable.").optional() }).strict().describe("Arguments for invoking the generated HTTP wrapper.")
};
