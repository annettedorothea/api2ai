    ...
    discoverTmdbMovies: z
        ...
        query: z
            ...
            certification_country: z
                .string()
                .describe('use in conjunction with the `certification`, `certification.gte` and `certification.lte` filters')
                .optional(),
            include_adult: z.boolean().optional(),
            ...
            with_release_type: z
                .number()
                .describe('possible values are: [1, 2, 3, 4, 5, 6] can be a comma (`AND`) or pipe (`OR`) separated query, can be used in conjunction with `region`')
                .optional(),
            'with_runtime.gte': z.number().optional(),
            'with_runtime.lte': z.number().optional(),
            with_watch_monetization_types: z
                .string()
                .describe('possible values are: [flatrate, free, ads, rent, buy] use in conjunction with `watch_region`, can be a comma (`AND`) or pipe (`OR`) separated query')
                .optional(),
            with_watch_providers: z
                .string()
                .describe('use in conjunction with `watch_region`, can be a comma (`AND`) or pipe (`OR`) separated query')
                .optional(),
