#!/usr/bin/env node
/**
 * Start all api2ai stateless HTTP MCP hosts in the background.
 */
...
function main() {
    ...
    console.warn('[mcp-http:all] mock-api MCP host needs mock-api backend (init or npm run demo:mock-api).');
}
