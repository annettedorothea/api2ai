#!/usr/bin/env node
/**
 * Start stateless HTTP MCP hosts used by init / mcp.json (todo-api, spaceflight-news).
 */
...
function main() {
    ...
    console.warn('[mcp-http:all] todo-api MCP host needs todo-api backend (init or npm run demo:todo-api).');
}
